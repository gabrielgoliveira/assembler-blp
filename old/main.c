...
void alloc_reg_param(int len, int index) {
  ...
  case 1:
    // registrador rdi
    registers_status[pos_inicial] = len;
    break;

  case 2:
    // registrador rsi
    registers_status[pos_inicial-1] = len;
    break;
  
  case 3:
    // registrador rdx
     registers_status[pos_inicial-2] = len;
    break;
...
int alloc_params_function(char *str) {
